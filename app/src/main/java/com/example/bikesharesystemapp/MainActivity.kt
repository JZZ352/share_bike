...
import com.example.bikesharesystemapp.databinding.ActivityMainBinding
import com.example.bikesharesystemapp.ui.database.DBViewModel
import com.example.bikesharesystemapp.utils.MyDatabaseHelper
...
//      supportActionBar?.hide()
        ...
        val appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.navigation_check, R.id.navigation_control, R.id.navigation_database,R.id.navigation_setting
            )
        )
...
//        Executors.newCachedThreadPool();创建一个可伸缩的线程池，即线程池大小根据实际情况调整，遇强则强，遇弱则弱。
        ...
        //写handler方法处理线程需要重写handleMessage方法
        ...
        //创建或打开数据库和表Sensor
        DBViewModel.db = MyDatabaseHelper(this,"SensorStore.db",2).writableDatabase
    }
